...
export default function Home() {
  ...
  {
    name: "감정 설계",
    description: "게임은 유저에게 어떤 기분이 들게 만들었을까.",
    games: ["대표작 분석 중"],
    href: "/tags/emotion-design",
  },
  {
    name: "몰입 설계",
    description: "유저를 어떤식으로 게임에 몰입하게 만들었을까.",
    games: ["Alan Wake 2"],
    href: "/tags/immersion-design",
  },
  {
    name: "책임 설계",
    description: "유저는 언제 선택의 결과에 책임을 질까.",
    games: ["Dark Souls"],
    href: "/tags/responsibility-design",
  },
  {
    name: "선택 설계",
    description: "선택이 자유로워 보이지만 자유도는 제한된다.",
    games: ["디스코엘리시움"],
    href: "/tags/choice-design",
  },
  {
    name: "지연 설계",
    description: "게임은 왜 특정부분에서 유저를 오래 머물게 만들까.",
    games: ["오브라딘호의 귀환"],
